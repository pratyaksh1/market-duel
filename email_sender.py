...
class EmailSender:
    ...
    def send_podcast(self, mp3_path, research_brief, sources_used=None):
        ...
        html = self._build_html(company, symbol, date_str, research_brief, sources_used or [])
    ...
    def _build_html(self, company, symbol, date_str, brief, sources_used):
...
<body style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto; color: #333;">
  ...
  <div style="background: #f8f9fa; padding: 20px; border-radius: 0 0 8px 8px; border: 1px solid #eee;">
    ...
    <p style="color: #aaa; font-size: 12px; margin-top: 16px;">
      Your Market Duel podcast is attached as an MP3. Listen on your commute or over morning chai ☕
    </p>
